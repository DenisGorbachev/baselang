...
edition = "2024"
rust-version = "1.93.0"
description = "Compiler analysis helpers for Baselang specs"
...
facet = { version = "0.44.3", features = ["reflect"] }
...
edition = "2024"
rust-version = "1.93.0"
description = "Specification for Baselang"
...
tempfile = "3.27.0"
thiserror = "2.0.18"
tokio = { version = "1.50.0", features = ["fs", "rt"] }
stub-macro = "0.2.1"
facet = { version = "0.44.3", features = ["reflect"] }
facet-pretty = "0.44.4"
...
use rustc_driver::{Callbacks, Compilation, DEFAULT_BUG_REPORT_URL, args::raw_args, catch_with_exit_code, init_rustc_env_logger, install_ctrlc_handler, install_ice_hook, run_compiler};
...
pub fn run() -> Result<ExitCode, RunError> {
    ...
    let raw_args = raw_args(&early_dcx);
